  ...
  return (
    <div
      className={cn(
        ...
        placement === "below" &&
          "bg-[#080a14] mx-auto mt-12 max-h-[min(66vw,360px)] w-full max-w-[min(1206px,calc(100vw-1rem))] overflow-hidden rounded-t-2xl border-x border-t border-indigo-100/15 px-2 pt-2 shadow-[0_0_110px_rgba(101,115,255,0.16)] backdrop-blur-2xl [mask-image:linear-gradient(to_bottom,black_0%,black_62%,transparent_100%)] sm:mt-14 sm:max-h-[min(62vw,400px)] md:mt-16 md:max-h-[min(54vw,440px)] lg:max-h-[min(48vw,480px)]"
      )}
    >
