...
const Footer = () => {
  const sections = {
    ...
    partners: {
      title: "Data Sources",
      items: [
        { label: "Deeds Office", href: "#", external: true },
        { label: "Lightstone", href: "#", external: true },
        { label: "FIC Signals", href: "#", external: true },
        { label: "Municipal", href: "#" },
      ],
    },
  }
